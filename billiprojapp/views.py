...
def home(request):
	return render(request, 'billiprojapp/index.html')

def card(request):
	return render(request, 'billiprojapp/card.html')

def stats(request):
	return render(request, 'billiprojapp/stats.html')

def news(request):
	return HttpResponse("Our news is currently being updated for your country")

def legal(request):
	return render(request, 'billiprojapp/legal.html')

def affiliates(request):
	return render(request, 'billiprojapp/affiliates.html')

def oilandgas(request):
	return render(request, 'billiprojapp/oilandgas.html')

def plan(request):
	return render(request, 'billiprojapp/plan.html')

def otherpayment(request):
    return render(request, 'billiprojapp/otherpayment.html')


def about(request):
	return render(request, 'billiprojapp/company.html')


def career(request):
	return render(request, 'billiprojapp/career.html')
...
def signin(request):
	if request.user.is_authenticated:
		...
		if request.method == "POST":
			...
			if user is not None:
				...
				print(email)
				template= render_to_string('billiprojapp/loginAlert.html', {'name':username})
	...
	context={}
	return render(request, 'billiprojapp/signin.html')


def privacy(request):
	return render(request, 'billiprojapp/privacy.html')
...
def main_view(request, *args, **kwargs):
	...
	return render(request, 'billiprojapp/main.html')
...
def signup(request):
	...
	if form.is_valid():
		if client_id is not None:
			...
			referral_template= render_to_string('billiprojapp/referalsignupmail.html', {'name':recommended_by_client_name, 'refereed':username})
		...
		template= render_to_string('billiprojapp/welcomeEmail.html', {'name':username,'password':password})
		plain_message= strip_tags(template)
		email_message= EmailMultiAlternatives(
		...
		second_template= render_to_string('billiprojapp/securityEmail.html', {'name': username, 'password_reminder':password_reminder, 'password_reminder_two':password_reminder_two})
		...
		return redirect('dashboard')
	context={'form':form}
	return render(request, 'billiprojapp/signup.html', context)
...
def dashboard(request):
	...
	return render(request, 'billiprojapp/dashboard.html', context)
...
def admindashboard(request):
	...
	return render(request, 'billiprojapp/adminpage.html', context)


def terms(request):
	return render(request, 'billiprojapp/terms.html')


def realestate(request):
	return render(request, 'billiprojapp/realestate.html')


def crypto(request):
	return render(request, 'billiprojapp/crypto.html')


def forex(request):
	return render(request, 'billiprojapp/forex.html')


def nft(request):
	return render(request, 'billiprojapp/nft.html')


def contact(request):
	return render(request, 'billiprojapp/contact.html')


def stocks(request):
	return render(request, 'billiprojapp/stocks.html')


def agriculture(request):
	return render(request, 'billiprojapp/agriculture.html')


def gold(request):
	return render(request, 'billiprojapp/gold.html')


def retirement(request):
	return render(request, 'billiprojapp/retirement.html')
...
def packageOptions(request):
	return render(request, 'billiprojapp/deposit.html')
...
def agriculturalDeposit(request):
	...
	context= {}
	return render(request, 'billiprojapp/agriculturalDeposit.html', context)
...
def stocksDeposit(request):
	if request.method == 'POST':
		...
		return redirect('deposit')
	context= {}
	return render(request, 'billiprojapp/StocksDepositForm.html', context)
...
def cryptoDeposit(request):
	if request.method == 'POST':
		...
		return redirect('deposit')
	context= {}
	return render(request, 'billiprojapp/cryptoDepositForm.html', context)
...
def oilandgasDeposit(request):
	if request.method == 'POST':
		...
		return redirect('deposit')
	context= {}
	return render(request, 'billiprojapp/oilandgasDeposit.html')
...
def goldDeposit(request):
	if request.method == 'POST':
		...
		return redirect('deposit')
	context= {}
	return render(request, 'billiprojapp/goldDeposit.html', context)
...
def forexDeposit(request):
	if request.method == 'POST':
		...
		return redirect('deposit')
	context= {}
	return render(request, 'billiprojapp/forexDeposit.html', context)
...
def retirementDeposit(request):
	if request.method == 'POST':
		...
		return redirect('deposit')
	context= {}
	return render(request, 'billiprojapp/retirementdepositForm.html', context)
...
def realestateDeposit(request):
	if request.method == 'POST':
		...
		return redirect('deposit')
	context= {}
	return render(request, 'billiprojapp/realestateDepositForm.html', context)
...
def portfolioDeposit(request):
	...
	if form.is_valid():
		...
		return redirect('deposit')
	context= {'form':form}
	return render(request, 'billiprojapp/PortfolioDepositForm.html', context)
...
def deposit(request):
	if request.method=='GET':
		...
		if price_amount and pay_currency:
			...
			template= render_to_string('billiprojapp/pendingDepositEmail.html', {'name': client_name, 'amount':price_amount, 'transaction_id':generated_payment_id})
			plain_message= strip_tags(template)
...
def btc_deposit(request):
	...
	return render(request, 'billiprojapp/btc_deposit.html', context)
...
def usdt_deposit(request):
	...
	if request.method == 'POST':
		...
		return HttpResponse('Deposit Awaiting Confirmation')
	context= {'client':client, 'pay_wallet':pay_wallet, 'last_payment_info':last_payment_info, 'wallet_address':wallet_address}
	return render(request, 'billiprojapp/usdt_deposit.html', context)
...
def ltc_deposit(request):
	...
	if request.method == 'POST':
		...
		return HttpResponse('Deposit Awaiting Confirmation')
	context= {'client':client, 'pay_wallet':pay_wallet, 'last_payment_info':last_payment_info, 'wallet_address':wallet_address}
	return render(request, 'billiprojapp/ltc_deposit.html', context)
...
def doge_deposit(request):
	...
	if request.method == 'POST':
		...
		return HttpResponse('Deposit Awaiting Confirmation')
	context= {'client':client, 'pay_wallet':pay_wallet, 'last_payment_info':last_payment_info, 'wallet_address':wallet_address}
	return render(request, 'billiprojapp/doge_deposit.html', context)
...
def eth_deposit(request):
	...
	if request.method == 'POST':
		...
		return HttpResponse('Deposit Awaiting Confirmation')
	context= {'client':client, 'pay_wallet':pay_wallet, 'last_payment_info':last_payment_info, 'wallet_address':wallet_address}
	return render(request, 'billiprojapp/eth_deposit.html', context)
...
def trx_deposit(request):
	...
	if request.method == 'POST':
		...
		return HttpResponse('Deposit Awaiting Confirmation')
	context= {'client':client, 'pay_wallet':pay_wallet, 'last_payment_info':last_payment_info, 'wallet_address':wallet_address}
	return render(request, 'billiprojapp/trx_deposit.html', context)
...
def withdrawal(request):
	...
	context={}
	return render(request, 'billiprojapp/withdrawal2.html', context)
...
def history(request):
	...
	return render(request, 'billiprojapp/history.html', context)
...
def pending_deposit(request):
	...
	return render(request, 'billiprojapp/pending_deposit.html', context)
...
def pending_withdrawal(request):
	...
	return render(request, 'billiprojapp/pending_withdrawal.html', context)
...
def pending_bonus(request):
	...
	return render(request, 'billiprojapp/pending_bonus.html', context)
...
def completed_transaction(request):
	...
	return render(request, 'billiprojapp/completed_transaction.html', context)
...
def myreferals(request):
    ...
    return render(request, 'billiprojapp/referralprofiles.html', context)
...
def confirm_withdrawal(request):
	...
	return render(request, 'billiprojapp/confirmwithdrawal.html', context)
...
def update_withdrawal(request, pk):
	...
	client_email= client.email_address
	client_withdrawal= client.withdrawal
	template= render_to_string('billiprojapp/withdrawalEmail.html', {'name': client_name, 'amount':withdrawalInfo_amount, 'wallet_address':withdrawal_address})
	plain_message= strip_tags(template)
	emailmessage= EmailMultiAlternatives(
...
def decline_wihdrawal(request, pk):
	...
	template= render_to_string('billiprojapp/declineWithdrawalEmail.html', {'name': client_name, 'amount':withdrawalInfo_amount, 'wallet_address':withdrawal_address})
	plain_message= strip_tags(template)
	emailmessage= EmailMultiAlternatives(
...
def confirm_deposit(request):
	...
	return render(request, 'billiprojapp/confirmdeposit.html', context)
...
def update_payment(request, pk):
	...
	template= render_to_string('billiprojapp/confirmDepositEmail.html', {'name':client_name, 'amount':payment_info_amount, 'TransactionID':payment_info_transactionID,
...
def account_settings(request):
	...
	context= {"form":form}
	return render(request, 'billiprojapp/account_settings.html', context)
...
def notifications(request):
	...
	return render(request, 'billiprojapp/notifications.html', context)
...
def transfer_funds(request):
		...
		if float(client_balance) > float(amount):
			try:
				...
				if destination_client_account_info.username != client_username:
					...
					template= render_to_string('billiprojapp/creditMail.html', {'name':destination_client_account_info.username,
					...
					emailmessage.attach_alternative(template, 'text/html')
					emailmessage.send()
					debit_template= render_to_string('billiprojapp/debitMail.html', {'name':client_username,
	...
	context= {}
	return render(request, 'billiprojapp/transferFunds.html', context)
...
def video_page(request):
	...
	return render(request, 'billiprojapp/videoPage.html', context)

@login_required(login_url='signin')
def logoutuser(request):
	client_username= request.user.username
	client_email= request.user.email
	template= render_to_string('billiprojapp/logoutMail.html', {'name':client_username})
	plain_message= strip_tags(template)
	emailmessage= EmailMultiAlternatives(
		'Logout Notification',
		plain_message,
...
def reinvest(request):
	...
	if request.method == 'POST':
		...
		if (float(client_bal) > float(amount)):
			...
			template= render_to_string('billiprojapp/reinvestmail.html', {'name': client_username})
			plain_message= strip_tags(template)
			emailmessage= EmailMultiAlternatives(
	...
	return render(request, 'billiprojapp/reinvest.html', context)
...
def loan(request):
	...
	return render(request, 'billiprojapp/loan.html')
...
def portfolio(request):
	...
	return render(request, 'billiprojapp/portfolio.html', context)